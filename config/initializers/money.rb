...
MoneyRails.configure do |config|
  ...
  currency = ISO4217::Currency.currencies
  all_currencies = currency.map(&:first)
  ...
  # currency_from = all_currencies.sample
  currency_from = "EUR"
  # currency_to = all_currencies.sample
  currency_to = "USD"

  amount = 100

  convert_money = Money.new(amount, currency_from).exchange_to(currency_to).fractional
